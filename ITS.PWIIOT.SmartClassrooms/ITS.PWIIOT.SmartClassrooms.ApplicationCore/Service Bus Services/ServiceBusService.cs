...
namespace ITS.PWIIOT.SmartClassrooms.ApplicationCore.Service_Bus_Services
{
    public class ServiceBusService : IMessage
    {
        ...
        public async Task StartReceiveMessagesFromSubscriptionAsync(Action<MessageFromDevice> processMessageFunc, string subscriptionName)
        {
            try
            {
                ...
                processor.ProcessMessageAsync += async args =>
                {
                    ...
                    var message = JsonSerializer.Deserialize<MessageFromDevice>(body);
